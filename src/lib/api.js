...
function getLocalRecords() {
  if (typeof window === 'undefined') return DEFAULT_SAMPLE_RECORDS;
  try {
    ...
    return Array.isArray(parsed) && parsed.length > 0 ? parsed : DEFAULT_SAMPLE_RECORDS;
  } catch (e) {
...
export async function fetchRecords() {
  ...
  // Fallback seamlessly to local browser storage
